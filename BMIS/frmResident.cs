...
namespace BMIS
{
    public partial class frmResident : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (MessageBox.Show("Do you want to save this record?", var._title,MessageBoxButtons.YesNo,MessageBoxIcon.Question) == DialogResult.Yes)
                {
                    ...
                    cn.Open();
                    cm = new SqlCommand("insert into tblresident (lname, fname, mname, alias, bdate, bplace, age, civilstatus, gender, religion, email, contact, voters, precint, purok, educational, occupation, address, category, house, head, disability, status, nid, pic)values(@lname, @fname, @mname, @alias, @bdate, @bplace, @age, @civilstatus, @gender, @religion, @email, @contact, @voters, @precint, @purok, @educational, @occupation, @address, @category, @house, @head, @disability, @status, @nid, @pic)", cn);
        ...
        {
            if (cboVoters.Text == "YES") { txtPrecint.Enabled = true; }else { txtPrecint.Enabled = false; txtPrecint.Clear(); }
        }
